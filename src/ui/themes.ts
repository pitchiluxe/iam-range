...
export const THEMES: readonly Theme[] = [
  ...
  },
  {
    id: 'rose',
    label: 'Rose',
    note: 'Warm pinks and muted reds.',
    mode: 'dark',
    tokens: {
      panel: '#1a1014',
      panelAlt: '#24171c',
      ...
      err: '#ff9a8a',
      warn: '#e2a03f',
      glassTop: 'rgba(72,46,56,0.64)',
      glassBottom: 'rgba(26,14,18,0.80)',
      glassBorder: 'rgba(255,255,255,0.12)',
      glassText: '#f0e6e9',
      glassHover: 'rgba(255,255,255,0.13)',
    },
  },
  {
    id: 'forest',
    label: 'Forest',
    note: 'Soft greens on a dark wood tone.',
    mode: 'dark',
    tokens: {
      panel: '#111c16',
      panelAlt: '#182922',
      ...
      err: '#ff9a8a',
      warn: '#e2a03f',
      glassTop: 'rgba(38,72,58,0.62)',
      glassBottom: 'rgba(14,28,22,0.80)',
      glassBorder: 'rgba(255,255,255,0.12)',
      glassText: '#e6efea',
      glassHover: 'rgba(255,255,255,0.13)',
    },
  },
  {
    ...
    tokens: {
      ...
      err: '#ff9a8a',
      warn: '#e2a03f',
      glassTop: 'rgba(78,60,36,0.62)',
      glassBottom: 'rgba(28,22,14,0.80)',
      glassBorder: 'rgba(255,255,255,0.12)',
      glassText: '#f2ece4',
      glassHover: 'rgba(255,255,255,0.13)',
    },
